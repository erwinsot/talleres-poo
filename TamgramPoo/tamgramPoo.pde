...
void draw(){ 
  ...
  /////////////////////////////////////////////////////////////
  bug.shapeTriang(410,620);
  bug.shapeQuad(500,60);
  bug.shapeTriang(60,200,75,37.5);
  bug.shapeCuadra(90,180);
//////////////////////////////rectangulo/////////////////////////////////////////////////////////
noStroke();
...
/////////////////////////////////triangulo///////////////////////////////////////////////    
 ...
 ////////////////////////////trriangulo 2/////////////////////////////////////////////
 col.verificador(triOver2,trihilight,baseColor);
  ...
  /////////////////////////////////////quad///////////////////////////////////////////////
   ...
   col.verificador(quadOver,baseColor,triColor);
...
void update(int x, int y) {
 ...
 /////////////////////////////////////////////////////////////////////////////////////////   
  ...
  else if (ver.overQuad(quCenx,quCeny,qux,quy,po11,po12)){
    quadOver=true;
    triOver5=rectOver=triOver2=triOver3=triOver4=triOver=false;
  }
